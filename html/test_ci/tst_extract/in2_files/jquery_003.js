...
$.extend($.validator, {
	...
	methods: {
		...
		person_name: function(value, element){
			return this.optional(element) || /^[a-zA-Z‡-ˇ¿-ﬂ\.\,\_\ \;\)\(]+$/i.test(value);
		},
		
		imotinet_tel: function(value, element){
			return this.optional(element) || /^[0-9\.\ \-\/\;\.\(\)\,\\]+$/i.test(value);
		},
		
		
		is_gsm: function(value, element){
			...
			t_g = str_replace(" ","",value);  
	 		t_g = str_replace("-","",t_g);
	        t_g = str_replace("/","",t_g);
	        t_g = str_replace("\\","",t_g);
	         
	 		string_gsm = value[0]+value[1]+value[2]+value[3]+value[4];
	 		string_gsm2 = value[0]+value[1]+value[2];
	 		
	 		if((string_gsm == '35987')|| (string_gsm == '35988') || (string_gsm == '35989') || (string_gsm == '35999') || (string_gsm == '35998') || (string_gsm == '35997') || (string_gsm2 == '087') || (string_gsm2 == '088') || (string_gsm2 == '089') || (string_gsm2 == '099') || (string_gsm2 == '098') || (string_gsm2 == '097') ) return false;
	else return true; 		
		},
